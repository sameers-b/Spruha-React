...
const Bootstrapicons = () => (
  <Fragment>
    ...
    <div className="page-header">
      <div>
        <h2 className="main-content-title tx-24 mg-b-5">Bootstrap-icons</h2>
        <Breadcrumb>
          <Breadcrumb.Item>{/* <a href="#">icons</a> */}</Breadcrumb.Item>
          <Breadcrumb.Item>Bootstrap-icons</Breadcrumb.Item>
        </Breadcrumb>
      </div>
