...
const MaterialDesignicons = () => (
  <Fragment>
    ...
    <div className="page-header">
      <div>
        <h2 className="main-content-title tx-24 mg-b-5">MaterialDesignIcons</h2>
        <Breadcrumb >
          <Breadcrumb.Item href="#"> Icons</Breadcrumb.Item>
          <Breadcrumb.Item active>MaterialDesignIcons</Breadcrumb.Item>
        </Breadcrumb>
      </div>
