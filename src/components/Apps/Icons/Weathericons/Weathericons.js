...
const Weathericons = () => (
  <Fragment>
    ...
    <div className="page-header">
      <div>
        <h2 className="main-content-title tx-24 mg-b-5">Weather Icons</h2>
        <Breadcrumb >
        ...
        <Card.Body>
          <Row className="row-sm">
            <Col lg={12} sm={12} className="mb-4">
              <h3 className="main-content-label">Weather icons</h3>
              <p className="mb-2">
                Simply beautiful open source icons. For more info
                <a href="https://erikflowers.github.io/weather-icons/"> click here</a>
                .
              </p>
              <p>
