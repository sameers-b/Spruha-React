...
import { Breadcrumb, Button, OverlayTrigger, Row, Tooltip, Card, Col } from "react-bootstrap";
...
const Simplelineicons = () => (
  <Fragment>
    ...
    <div className="page-header">
      <div>
        <h2 className="main-content-title tx-24 mg-b-5">Simpleline Icons</h2>
        <Breadcrumb >
          <Breadcrumb.Item >
            Icons
          </Breadcrumb.Item>
            ...
            <Row className="row-sm">
              <Col lg={12} sm={12} className=" mb-4">
                ...
                <p className="mb-2">
                  ...
                  <a href="https://simplelineicons.com" > click here
                  </a>
                  .
                </p>
                <p>
                ...
                <div className="icons-list-wrap">
                  <ul className="icons-list">
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-user" title="si-user"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>si-people</Tooltip>}
                      >
                        <i className="si si-people" title="si-people"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>si-user-female</Tooltip>}
                      >
                        <i
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-login" title="si-login"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-logout" title="si-logout"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-emotsmile" title="si-emotsmile"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-call-end" title="si-call-end"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-call-in" title="si-call-in"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-call-out" title="si-call-out"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-map" title="si-map"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>si-location-pin</Tooltip>}
                      >
                        <i
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-direction" title="si-direction"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-compass" title="si-compass"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-layers" title="si-layers"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-menu" title="si-menu"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-list" title="si-list"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-options" title="si-options"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-arrow-up" title="si-arrow-up"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-check" title="si-check"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-clock" title="si-clock"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-plus" title="si-plus"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-close" title="si-close"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-trophy" title="si-trophy"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-plane" title="si-plane"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-notebook" title="si-notebook"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-mustache" title="si-mustache"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-mouse" title="si-mouse"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-magnet" title="si-magnet"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-energy" title="si-energy"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-disc" title="si-disc"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-cursor" title="si-cursor"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-crop" title="si-crop"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-chemistry" title="si-chemistry"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-shield" title="si-shield"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-hourglass" title="si-hourglass"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-ghost" title="si-ghost"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-fire" title="si-fire"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-eyeglass" title="si-eyeglass"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-bell" title="si-bell"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-badge" title="si-badge"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-anchor" title="si-anchor"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-wallet" title="si-wallet"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-vector" title="si-vector"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-speech" title="si-speech"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-puzzle" title="si-puzzle"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-printer" title="si-printer"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-present" title="si-present"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-playlist" title="si-playlist"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>i-pin</Tooltip>}
                      >
                        <i className="si si-pin" title="si-pin"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>si-picture</Tooltip>}
                      >
                        <i className="si si-picture" title="si-picture"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-handbag" title="si-handbag"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-globe-alt" title="si-globe-alt"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-globe" title="si-globe"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-folder" title="si-folder"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-film" title="si-film"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-feed" title="si-feed"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-drop" title="si-drop"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-drawer" title="si-drawer"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-docs" title="si-docs"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>i-doc</Tooltip>}
                      >
                        <i className="si si-doc" title="si-doc"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>si-diamond</Tooltip>}
                      >
                        <i className="si si-diamond" title="si-diamond"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>i-cup</Tooltip>}
                      >
                        <i className="si si-cup" title="si-cup"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-bubbles" title="si-bubbles"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-briefcase" title="si-briefcase"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-book-open" title="si-book-open"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-basket" title="si-basket"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>i-bag</Tooltip>}
                      >
                        <i className="si si-bag" title="si-bag"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>si-action-undo</Tooltip>}
                      >
                        <i
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-wrench" title="si-wrench"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-umbrella" title="si-umbrella"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-trash" title="si-trash"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>i-tag</Tooltip>}
                      >
                        <i className="si si-tag" title="si-tag"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>si-support</Tooltip>}
                      >
                        <i className="si si-support" title="si-support"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-shuffle" title="si-shuffle"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-share-alt" title="si-share-alt"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-share" title="si-share"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-rocket" title="si-rocket"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-question" title="si-question"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-pie-chart" title="si-pie-chart"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-pencil" title="si-pencil"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-note" title="si-note"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-loop" title="si-loop"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-home" title="si-home"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-grid" title="si-grid"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-graph" title="si-graph"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-earphones" title="si-earphones"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-equalizer" title="si-equalizer"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-like" title="si-like"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-dislike" title="si-dislike"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-volume-1" title="si-volume-1"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-volume-2" title="si-volume-2"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-calendar" title="si-calendar"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-bulb" title="si-bulb"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-chart" title="si-chart"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>i-ban</Tooltip>}
                      >
                        <i className="si si-ban" title="si-ban"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-bubble" title="si-bubble"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-camera" title="si-camera"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-envelope" title="si-envelope"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>i-eye</Tooltip>}
                      >
                        <i className="si si-eye" title="si-eye"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-flag" title="si-flag"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-heart" title="si-heart"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-info" title="si-info"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>i-key</Tooltip>}
                      >
                        <i className="si si-key" title="si-key"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-link" title="si-link"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-lock" title="si-lock"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-lock-open" title="si-lock-open"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-magnifier" title="si-magnifier"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-power" title="si-power"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-refresh" title="si-refresh"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-reload" title="si-reload"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-settings" title="si-settings"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                      ...
                      >
                        <i className="si si-star" title="si-star"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-target" title="si-target"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      ...
                      >
                        <i className="si si-paypal" title="si-paypal"></i>
                      </OverlayTrigger>
                    </li>
                    <li className="icons-list-item">
                      <OverlayTrigger
                    ...
                    <li className="icons-list-item">
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>si-social-behance</Tooltip>}
                      >
                        <i
