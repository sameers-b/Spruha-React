	...
	<Fragment>
		<div className="page main-signin-wrapper bg-primary br-0-f">
			<div className="d-flex header-setting-icon demo-icon fa-spin">
				<span className="nav-link icon" onClick={() => Customswitcherdata.Swicherbutton()}>
					...
					<Card className="card alert-message">
						<Card.Body>
							<div className="text-center text-white">
								...
								<Link to={`${process.env.PUBLIC_URL}/dashboard/`} className="btn btn-warning">Back to Home</Link>
							</div>
						</Card.Body>
					</Card>
				</Col>
